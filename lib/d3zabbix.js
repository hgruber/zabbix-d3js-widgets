...
function timeSeries(arg) {
    ...
    var tick_sizing = [
        [    1.2, d3.time.seconds, 15 ],
        [    3.6, d3.time.minutes,  1 ],
        [   14.4, d3.time.minutes,  5 ],
        [   43.2, d3.time.minutes, 15 ],
        [   86.4, d3.time.minutes, 30 ],
        [  172.8, d3.time.hours,    1 ],
        [  432.0, d3.time.hours,    2 ],
        [  604.8, d3.time.hours,    6 ],
        [ 1209.6, d3.time.hours,   12 ],
        [ 2592.0, d3.time.days,     1 ],
        [ 5184.0, d3.time.days,     2 ],
        [10368.0, d3.time.days,     7 ],
        [41472.0, d3.time.months,   1 ]
    ];
    ...
    var margin = { top: 10, right: 20, bottom: 18, left: 50 };
    ...
    function plotFuture(t) {
        ...
        if (x(now) < width + margin.left) {
            future
                .attr("x", x(now))
                .attr("y", margin.top)
                .attr("width", width + margin.left - x(now))
