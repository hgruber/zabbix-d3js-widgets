...
function timeSeries(arg) {
    ...
    svg
        ...
        .on('mouseleave', function() {
            d3.select(".info").selectAll("circle").remove();
            d3.select(".info").selectAll("text").remove();
            d3.select(".info").selectAll("line").remove();
        })
        .call(zoom)
        .call(drag);
...
/*      var dontRequest = addition(scales[activeScale].range, []);
    ...
    function plotInfo() {
        ...
        var infoCircle = d3.select(".info").selectAll("circle")
        ...
        var infoText = d3.select(".info").selectAll("text")
            .data(selected, function(s,i) { return i; })
            .attr("x", mx+14)
        ...
        var infoLine = d3.select(".info").selectAll("line")
            .data(selected, function(s,i) { return i; })
