...
function timeSeries(arg) {
    ...
    var tick_sizing = [
        [    1200, d3.time.seconds, 15 ],
        [    3600, d3.time.minutes,  1 ],
        [   14400, d3.time.minutes,  5 ],
        [   43200, d3.time.minutes, 15 ],
        [   86400, d3.time.minutes, 30 ],
        [  172800, d3.time.hours,    1 ],
        [  432000, d3.time.hours,    2 ],
        [  604800, d3.time.hours,    6 ],
        [ 1209600, d3.time.hours,   12 ],
