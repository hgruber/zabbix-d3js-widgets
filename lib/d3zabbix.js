        ...
        gant.forEach(function(g, i) {
            ...
            scales[activeScale].values[i].forEach(function(v,j) {
                ...
                if (!gantNames.hasOwnProperty(name)) {
                    ...
                    else g.push([ v[0], v[0], name ]);
                } else {
                    if (begin) {
                        g.push([ v[0], gantNames[name][1], name ]);
                    } else if (end) {
                        g.push([ gantNames[name][0], v[0], name ]);
                    }
    ...
    function plotGant() {
        function setGant(selection) {
            selection
                ...
                .attr("y", function(d,i) {
                    return margin.top + 5*i;
                })
                .attr("width", function(d,i) {
                    return Math.round(x(d[1]*1000)-x(d[0]*1000));
                })
        ...
        var x0 = Math.round(xRange[0]/1000);
        var x1 = Math.round(xRange[1]/1000);
        var gC = gantChart.selectAll("rect").data(gant[0], function(o,i) {
                return o[2]+o[0];
            })
            .call(setGant)
        gC  .enter()
